...
public class TestLabirintoBuilder {
	...
	public void testMonolocaleConAttrezzoSingoloDuplicato() {
		...
		assertTrue(size==1);
		assertEquals(Arrays.asList(new Attrezzo("spada",1)).toString(),monolocale.getStanzaCorrente().getAttrezzi().toString());
	}
	...
	public void testBilocale() {
		Labirinto bilocale = labirintoBuilder
				...
				.getLabirinto();
		assertEquals(bilocale.getStanzaVincente().toString(),bilocale.getStanzaCorrente().getStanzaAdiacente("nord").toString());
	...
	public void testTrilocaleConStanzaDuplicata() {
				...
				.getLabirinto();
		assertTrue(labirintoBuilder.getNomeToStanza().size()<=2);
	}
	...
	public void testAggiuntaAttrezziAStanze_AppenaAggiunte() {
		...
		labirintoBuilder
				...
				.addAttrezzo(nomeAttrezzo, peso)
				.getLabirinto();
		assertTrue(this.labirintoBuilder.getNomeToStanza().get(nomeStanza).getAttrezzi().contains(new Attrezzo (nomeAttrezzo,peso)));
		assertEquals(new Attrezzo(nomeAttrezzo,peso),this.labirintoBuilder.getNomeToStanza().get(nomeStanza).getAttrezzo(nomeAttrezzo));
	}
	...
	public void testAggiuntaAttrezzoAStanze_AppenaAggiunteMultiple() {
		...
		this.labirintoBuilder
				...
				.getLabirinto();
		Attrezzo attrezzo = new Attrezzo(nomeAttrezzo,peso);
		List<Attrezzo> attrezzi = new LinkedList<Attrezzo>(labirintoBuilder.getNomeToStanza().get(nomeStanza).getAttrezzi());
	...
	public void testAggiuntaAttrezzoAStanze_MoltepliciAttrezziStessaStanza() {
		...
		Map<String, Stanza> listaStanze = labirintoBuilder.getNomeToStanza();
	...
	public void testLabirintoConStanzaMagica() {
		...
		StanzaMagica stanzaMagica = (StanzaMagica)labirintoBuilder.getNomeToStanza().get(nomeStanzaMagica);
	...
	public void testLabirintoConStanzaBloccata_ConPassepartout() {
		...
		assertEquals(stanzaVincente,labirintoBuilder.getNomeToStanza().get("stanza bloccata").getStanzaAdiacente("nord"));	
	}
	...
	public void testLabirintoConStanzaBloccata_SenzaPassepartout() {
		...
		assertEquals(stanzaBloccata,labirintoBuilder.getNomeToStanza().get("stanza bloccata").getStanzaAdiacente("nord"));
	}
